...
[Quick Start Guide](../README.md) - Start here for deployment instructions and setup.
...
- [Blueprint Creation (PowerShell)](../BLUEPRINT-CREATION-POWERSHELL.md) - Create Agent Identity Blueprints using PowerShell
- [Blueprint Creation (Custom Client)](../BLUEPRINT-CREATION-CUSTOM-CLIENT.md) - Create Blueprints programmatically via Graph API
- [OBO Guide](../OBO-GUIDE.md) - Testing User On-Behalf-Of flows with Entra Agent ID SDK
- [Workload Identity Guide](../WORKLOAD-IDENTITY-GUIDE.md) - Configure workload identity federation for Kind clusters

## Reference Documentation

- [Entra Agent ID Identity Platform](../reference/entra-agent-id-identity-platform.md)
- [Entra MSIDWeb Agent ID SDK](../reference/entra-msidweb-agent-id-sdk.md)
- [Entra Workload ID](../reference/entra-workload-id.md)

## Additional Resources

- [AI Agent CLI Demo](../ai-agent-cli/README.md) - Full working example application
- [Kubernetes Deployment Notes](../kubernetes/NOTES.md) - Kubernetes-specific deployment details
